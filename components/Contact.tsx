...
const fieldClassName =
  "min-h-[48px] w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-base text-white placeholder:text-white/40 outline-none transition-colors focus:border-accent-500/50 focus-visible:ring-2 focus-visible:ring-accent-500/40";
...
export default function Contact() {
  ...
  return (
    <Chapter
      id="contact"
      backgroundSrc="/images/chapters/contact-backdrop.png"
      eyebrow={dict.contact.eyebrow}
      title={dict.contact.title}
      body={dict.contact.subtitle}
    >
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-5">
            ...
            <div>
              ...
              >
                ...
                {PREFERRED_TIMES.map((key) => (
                  <option key={key} value={key}>
                    {dict.contact.preferredTimes[key]}
                  </option>
                ))}
              </select>
